document.addEventListener('DOMContentLoaded', () => {
    ...
    const ramos = [
        // Semestre 1
        { id: 'IND-111', nombre: 'Álgebra', creditos: 8, semestre: 1, prerequisitos: [] },
        { id: 'IND-112', nombre: 'Cálculo I', creditos: 8, semestre: 1, prerequisitos: [] },
        { id: 'IND-113', nombre: 'Com. en Ingeniería', creditos: 5, semestre: 1, prerequisitos: [] },
        ...
        // Semestre 3
        { id: 'IND-213', nombre: 'Prob. y Estadística', creditos: 5, semestre: 3, prerequisitos: ['IND-121'] },
        { id: 'IND-211', nombre: 'Cálculo III', creditos: 8, semestre: 3, prerequisitos: ['IND-122'] },
        { id: 'IND-212', nombre: 'Física I', creditos: 8, semestre: 3, prerequisitos: ['IND-112'] },
        ...
        { id: 'IND-221', nombre: 'Ecuaciones Diferenciales', creditos: 8, semestre: 4, prerequisitos: ['IND-211'] },
        { id: 'IND-222', nombre: 'Física II', creditos: 8, semestre: 4, prerequisitos: ['IND-212'] },
        { id: 'IND-334', nombre: 'Módulo Integ. CC.BB.', creditos: 8, semestre: 4, prerequisitos: ['IND-213' , 'IND-214' , 'IND-211' , 'IFG-300' , 'IND-212'] },
        // Semestre 5
        ...
        { id: 'IND-312', nombre: 'Termodinám.', creditos: 8, semestre: 5, prerequisitos: ['IND-222'] },
        { id: 'IND-314', nombre: 'Adm. y RRHH', creditos: 5, semestre: 5, prerequisitos: [] },
        { id: 'MFG-114', nombre: 'Introducción a la Fe', creditos: 5, semestre: 5, prerequisitos: [] },
        // Semestre 6
        { id: 'IND-322', nombre: 'Logística', creditos: 5, semestre: 6, prerequisitos: ['IND-311'] },
        { id: 'IND-321', nombre: 'Elect. Ind. y Automatiz.', creditos: 6, semestre: 6, prerequisitos: ['IND-313'] },
        { id: 'IND-324', nombre: 'Contab. y Finanzas', creditos: 5, semestre: 6, prerequisitos: [] },
        { id: 'IND-323', nombre: 'Economía', creditos: 5, semestre: 6, prerequisitos: ['IND-314'] },
        { id: 'IND-325', nombre: 'Base de Datos', creditos: 4, semestre: 6, prerequisitos: ['IND-214'] },
        { id: 'MFG-214', nombre: 'Ética Cristiana', creditos: 5, semestre: 6, prerequisitos: ['MFG-114'] },
        // Semestre 7
        ...
        // Semestre 9
        { id: 'IND-511', nombre: 'Optimiza.', creditos: 5, semestre: 9, prerequisitos: ['IND-421'] },
        { id: 'IND-512', nombre: 'Gestión Información', creditos: 5, semestre: 9, prerequisitos: ['IND-422'] },
        { id: 'IND-513', nombre: 'Formal. y Ev. de Proyectos', creditos: 5, semestre: 9, prerequisitos: ['IND-414'] },
        { id: 'IND-514', nombre: 'Propiedad Intelectual', creditos: 5, semestre: 9, prerequisitos: [] },
        ...
        // Semestre 10
        { id: 'IND-521', nombre: 'Gestión Calidad Prod.', creditos: 5, semestre: 10, prerequisitos: ['IND-412'] },
        { id: 'IND-522', nombre: 'Electivo Ev. Proyectos', creditos: 5, semestre: 10, prerequisitos: [] },
        { id: 'IND-523', nombre: 'Plan. Estrat. y Gestión Negocios', creditos: 5, semestre: 10, prerequisitos: [] },
        { id: 'IND-524', nombre: 'Gestión Proyectos I+D+e', creditos: 5, semestre: 10, prerequisitos: ['IND-514'] },
